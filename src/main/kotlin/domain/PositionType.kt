...
sealed class PositionType(
    ...
    object SecondDungeon : PositionType(enum = SECOND_DUNGEON, ignoreToExpand = true, color = Color(255, 0, 0))
    object ThirdDungeon : PositionType(enum = THIRD_DUNGEON, ignoreToExpand = true, color = Color(255, 0, 0))
    object Link : PositionType(enum = LINK, ignoreToExpand = true, color = Color.CYAN)
